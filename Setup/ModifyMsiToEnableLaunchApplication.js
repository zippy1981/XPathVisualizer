...
// the install has completed.  Also reformats and prettifies some of the
// text in the install wizard.
// 
// Thu, 17 Sep 2009  12:01
//
...
// Configurable values
var checkboxChecked = false;                // Is the checkbox on the finished dialog checked 
                                            // by default?
var checkboxText = "Launch [ProductName]";  // Text for the checkbox on the finished dialog
var filename     = "XPathVisualizer.exe";   // The name of the executable to launch - change 
                                            // this to match the file you want to launch at 
...
try
{
    ...
    WScript.Echo("Updating the text in the wizard...");
    ...
    // EULA
    UpdateText("EulaForm", 
               "{\\VSI_MS_Sans_Serif16.0_1_0}Here`s the License for the XPath Visualizer.\r\nYou have to accept it to proceed.",
              "BannerText");
    ...
    UpdateText("FinishedForm", 
               "{\\VSI_MS_Sans_Serif16.0_1_0}The setup for [ProductName] is complete.",
               "BannerText");
